...
%% Error code in server response on status request
...
%% Error code in status response
-define(SMS_HLR_CODE, [{-3,  <<"Сообщение не найдено"/utf8>>},
...
-define(SMS_HRL_ERR,  [{0, <<"Нет ошибки"/utf8>>},
