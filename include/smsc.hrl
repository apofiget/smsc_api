...
-define(SMS_HRL_ERR_CODE,  [{0, <<"Нет ошибки"/utf8>>},
                            ...
                            {200, <<"Виртуальная отправка"/utf8>>},
                            {220, <<"Переполнена очередь у оператора"/utf8>>},
                            {240, <<"Абонент занят"/utf8>>},
                            {241, <<"Ошибка конвертации звука"/utf8>>},
                            {242, <<"Зафиксирован автоответчик"/utf8>>},
                            {243, <<"Не заключен договор"/utf8>>},
                            {244, <<"Рассылки запрещены"/utf8>>},
